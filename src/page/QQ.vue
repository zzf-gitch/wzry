...
import { successmessage,errormessage,warningmessage } from "../api/message.js";
...
const str=ref('请输入账号')
const change=()=>{
  let strArr=['请输入账号','小旭','狗王','dog king','无敌旭']
  let index=Math.floor(Math.random()*strArr.length)
  str.value=strArr[index]
  setTimeout(()=>{
    change()
  },1000)
}
